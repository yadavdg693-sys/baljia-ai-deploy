...
import { getOwnedAgentRun, listRunMessages } from '@/lib/agents/runtime/agent-run-api.service';
...
export async function GET(
  ...
  return NextResponse.json({ run_id: runId, messages: await listRunMessages(runId) });
}
