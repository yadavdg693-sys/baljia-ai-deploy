...
import { getOwnedAgentRun, listRunEvents } from '@/lib/agents/runtime/agent-run-api.service';
...
export async function GET(
  ...
  return NextResponse.json({ run_id: runId, events: await listRunEvents(runId) });
}
