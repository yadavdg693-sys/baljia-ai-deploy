...
import { getOwnedAgentRun, listRunToolCalls } from '@/lib/agents/runtime/agent-run-api.service';
...
export async function GET(
  ...
  return NextResponse.json({ run_id: runId, tool_calls: await listRunToolCalls(runId) });
}
