...
export const metadata: Metadata = {
  ...
  openGraph: { title: 'Baljia AI — Your AI Angel', description: 'AI that runs your company while you sleep.', url: 'https://baljia.ai', siteName: 'Baljia AI', locale: 'en_US', type: 'website' },
  twitter: { card: 'summary_large_image', title: 'Baljia AI — Your AI Angel', description: 'AI that runs your company while you sleep.' },
