...
ALTER TABLE "ad_spend_ledger" ADD CONSTRAINT "ad_spend_ledger_company_id_companies_id_fk" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "agent_tool_mounts" ADD CONSTRAINT "agent_tool_mounts_agent_id_agents_id_fk" FOREIGN KEY ("agent_id") REFERENCES "public"."agents"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "agent_tool_mounts" ADD CONSTRAINT "agent_tool_mounts_mcp_server_id_mcp_servers_id_fk" FOREIGN KEY ("mcp_server_id") REFERENCES "public"."mcp_servers"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "approval_records" ADD CONSTRAINT "approval_records_task_id_tasks_id_fk" FOREIGN KEY ("task_id") REFERENCES "public"."tasks"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "browser_credentials" ADD CONSTRAINT "browser_credentials_company_id_companies_id_fk" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "credit_ledger" ADD CONSTRAINT "credit_ledger_task_id_tasks_id_fk" FOREIGN KEY ("task_id") REFERENCES "public"."tasks"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "dashboard_links" ADD CONSTRAINT "dashboard_links_company_id_companies_id_fk" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "document_suggestions" ADD CONSTRAINT "document_suggestions_company_id_companies_id_fk" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "document_suggestions" ADD CONSTRAINT "document_suggestions_task_id_tasks_id_fk" FOREIGN KEY ("task_id") REFERENCES "public"."tasks"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "learnings" ADD CONSTRAINT "learnings_company_id_companies_id_fk" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "learnings" ADD CONSTRAINT "learnings_task_id_tasks_id_fk" FOREIGN KEY ("task_id") REFERENCES "public"."tasks"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "mcp_tools" ADD CONSTRAINT "mcp_tools_server_id_mcp_servers_id_fk" FOREIGN KEY ("server_id") REFERENCES "public"."mcp_servers"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "memory_layers" ADD CONSTRAINT "memory_layers_company_id_companies_id_fk" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "milestone_criteria" ADD CONSTRAINT "milestone_criteria_milestone_id_milestones_id_fk" FOREIGN KEY ("milestone_id") REFERENCES "public"."milestones"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "milestones" ADD CONSTRAINT "milestones_company_id_companies_id_fk" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "night_shift_cycles" ADD CONSTRAINT "night_shift_cycles_company_id_companies_id_fk" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "platform_events" ADD CONSTRAINT "platform_events_company_id_companies_id_fk" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "platform_feedback" ADD CONSTRAINT "platform_feedback_company_id_companies_id_fk" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "recurring_tasks" ADD CONSTRAINT "recurring_tasks_company_id_companies_id_fk" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "refund_history" ADD CONSTRAINT "refund_history_company_id_companies_id_fk" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "refund_history" ADD CONSTRAINT "refund_history_task_id_tasks_id_fk" FOREIGN KEY ("task_id") REFERENCES "public"."tasks"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "revenue_ledger" ADD CONSTRAINT "revenue_ledger_company_id_companies_id_fk" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "roadmaps" ADD CONSTRAINT "roadmaps_company_id_companies_id_fk" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "task_executions" ADD CONSTRAINT "task_executions_task_id_tasks_id_fk" FOREIGN KEY ("task_id") REFERENCES "public"."tasks"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "task_executions" ADD CONSTRAINT "task_executions_agent_id_agents_id_fk" FOREIGN KEY ("agent_id") REFERENCES "public"."agents"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "task_failure_links" ADD CONSTRAINT "task_failure_links_task_id_tasks_id_fk" FOREIGN KEY ("task_id") REFERENCES "public"."tasks"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "task_failure_links" ADD CONSTRAINT "task_failure_links_fingerprint_id_failure_fingerprints_id_fk" FOREIGN KEY ("fingerprint_id") REFERENCES "public"."failure_fingerprints"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "tasks" ADD CONSTRAINT "tasks_assigned_to_agent_id_agents_id_fk" FOREIGN KEY ("assigned_to_agent_id") REFERENCES "public"."agents"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "tweets" ADD CONSTRAINT "tweets_company_id_companies_id_fk" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "tweets" ADD CONSTRAINT "tweets_task_id_tasks_id_fk" FOREIGN KEY ("task_id") REFERENCES "public"."tasks"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "idx_agent_tool_mounts_unique" ON "agent_tool_mounts" USING btree ("agent_id","mcp_server_id");--> statement-breakpoint
CREATE INDEX "idx_approval_records_task" ON "approval_records" USING btree ("task_id");--> statement-breakpoint
CREATE INDEX "idx_artifacts_run" ON "artifacts" USING btree ("run_id");--> statement-breakpoint
CREATE INDEX "idx_artifacts_task" ON "artifacts" USING btree ("task_id");--> statement-breakpoint
CREATE UNIQUE INDEX "idx_browser_creds_unique" ON "browser_credentials" USING btree ("company_id","site_domain");--> statement-breakpoint
CREATE INDEX "idx_chat_sessions_company" ON "chat_sessions" USING btree ("company_id");--> statement-breakpoint
CREATE INDEX "idx_companies_owner" ON "companies" USING btree ("owner_id");--> statement-breakpoint
CREATE INDEX "idx_companies_lifecycle" ON "companies" USING btree ("lifecycle");--> statement-breakpoint
CREATE INDEX "idx_contacts_company" ON "contacts" USING btree ("company_id");--> statement-breakpoint
CREATE INDEX "idx_credit_ledger_company" ON "credit_ledger" USING btree ("company_id");--> statement-breakpoint
CREATE INDEX "idx_dashboard_links_company" ON "dashboard_links" USING btree ("company_id");--> statement-breakpoint
CREATE UNIQUE INDEX "idx_dashboard_links_unique" ON "dashboard_links" USING btree ("company_id","label");--> statement-breakpoint
...
CREATE INDEX "idx_learnings_company" ON "learnings" USING btree ("company_id");--> statement-breakpoint
CREATE INDEX "idx_magic_link_token" ON "magic_link_tokens" USING btree ("token");--> statement-breakpoint
CREATE UNIQUE INDEX "idx_mcp_tools_unique" ON "mcp_tools" USING btree ("server_id","name");--> statement-breakpoint
CREATE UNIQUE INDEX "idx_memory_company_layer" ON "memory_layers" USING btree ("company_id","layer");--> statement-breakpoint
CREATE INDEX "idx_criteria_milestone" ON "milestone_criteria" USING btree ("milestone_id");--> statement-breakpoint
CREATE INDEX "idx_criteria_status" ON "milestone_criteria" USING btree ("is_met");--> statement-breakpoint
CREATE INDEX "idx_milestones_roadmap" ON "milestones" USING btree ("roadmap_id");--> statement-breakpoint
CREATE INDEX "idx_milestones_company" ON "milestones" USING btree ("company_id");--> statement-breakpoint
CREATE INDEX "idx_milestones_status" ON "milestones" USING btree ("status");--> statement-breakpoint
CREATE INDEX "idx_milestones_phase" ON "milestones" USING btree ("roadmap_id","phase","sort_order");--> statement-breakpoint
CREATE INDEX "idx_events_company" ON "platform_events" USING btree ("company_id");--> statement-breakpoint
CREATE INDEX "idx_events_type" ON "platform_events" USING btree ("event_type");--> statement-breakpoint
CREATE INDEX "idx_platform_feedback_company" ON "platform_feedback" USING btree ("company_id");--> statement-breakpoint
CREATE INDEX "idx_reports_company" ON "reports" USING btree ("company_id");--> statement-breakpoint
CREATE INDEX "idx_reports_task" ON "reports" USING btree ("task_id");--> statement-breakpoint
CREATE UNIQUE INDEX "idx_roadmaps_company" ON "roadmaps" USING btree ("company_id");--> statement-breakpoint
CREATE INDEX "idx_roadmaps_status" ON "roadmaps" USING btree ("status");--> statement-breakpoint
...
CREATE INDEX "idx_executions_task" ON "task_executions" USING btree ("task_id");--> statement-breakpoint
...
CREATE INDEX "idx_tasks_company_order" ON "tasks" USING btree ("company_id","queue_order");--> statement-breakpoint
