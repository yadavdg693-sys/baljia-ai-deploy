> Adapted from [nexu-io/open-design](https://github.com/nexu-io/open-design) `craft/form-validation.md` (Apache License 2.0).
> Upstream: https://github.com/nexu-io/open-design/blob/2afb002a6285f92ec80e6cee97f867dc7a680a77/craft/form-validation.md
...
the same validation work on the server and the client. The skeleton's
`app/globals.css` shadcn/ui CSS variables (`--primary`, `--destructive`,
`--ring`, `--background`, `--foreground`, `--muted`, `--border`) consumed
via Tailwind classes decide how the field looks; this file decides *when*
the field tells the user it's wrong, *how* the error reaches assistive
