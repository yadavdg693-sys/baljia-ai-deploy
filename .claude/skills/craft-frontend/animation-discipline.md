> Adapted from [nexu-io/open-design](https://github.com/nexu-io/open-design) `craft/animation-discipline.md` (Apache License 2.0).
> Upstream: https://github.com/nexu-io/open-design/blob/2afb002a6285f92ec80e6cee97f867dc7a680a77/craft/animation-discipline.md
...
constrain it. The skeleton's `app/globals.css` shadcn/ui CSS variables
(`--primary`, `--accent`, `--ring`, `--background`, `--foreground`,
`--muted`, `--border`) consumed via Tailwind classes decide brand-specific
motion personality; this file decides whether motion should run at all and
at what duration, easing, and accessibility floor.
