> Adapted from [nexu-io/open-design](https://github.com/nexu-io/open-design) `craft/typography.md` (Apache License 2.0).
> Upstream: https://github.com/nexu-io/open-design/blob/2afb002a6285f92ec80e6cee97f867dc7a680a77/craft/typography.md
...
Universal typography rules that apply on top of any design system. The
...
- Always declare a system fallback chain. If the active design system
